                ...
                <View style={styles.padView}>
                  ...
                  <View>
                    <Text>
                      ...
                      {this.props.product.minimal_price}
                    </Text>
                    {this.props.product.is_bidden ? (
                  ...
                  {this.props.product.is_bidden ? (
                    <View>
                      <View style={styles.center}>
                        <Text style={styles.title}>Top bid user contact</Text>
                      </View>
                      {/*Bids on the auction*/}
                      <View style={styles.wellBox}>
                        ...
                        <Text>
                          <Icon name="md-call" color={colors.accent} />
                          {'\t \t' +
                            this.props.product.high_bid_user.phone +
                            '\n'}
                        </Text>
                        <Text>
                          <Icon name="md-mail" color={colors.accent} />
                          {'\t \t' +
                            this.props.product.high_bid_user.email +
                            '\n'}
                        </Text>
                      </View>
                    </View>
                    ...
                    <View style={{ alignItems: 'center', paddingTop: 20 }}>
                      <Text style={styles.mute}>
                        This product has not yet bidden
                      </Text>
                    </View>
                  )}
                </View>
