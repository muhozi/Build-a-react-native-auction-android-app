...
class Product extends React.Component {
  ...
  validate() {
    if (this.state.price == '') {
      ...
      this.setState({
        responseMsg:
          'Please enter a valid price (number & not less than Rwf 500)',
        statusColor: 'red'
      });
      return false;
    } else {
                      ...
                      if (this.validate()) {
                        fetch(config.url + 'api/bid/' + this.props.product.id, {
                          ...
                          .catch(error => {
                            ...
                            this.setState({
                              responseMsg: 'Internet network failed !'
                            });
                            console.log(error);
                            this.setState({
                              networkResponse:
            ...
            {this.props.product.id ? (
              <View>
                ...
                <View>
                  ...
                  <Text style={styles.padTop}>
                    <Text style={styles.label}>
                      {this.props.product.is_ended ? 'Ended on' : 'Will end on'}
                    </Text>{' '}
                    &nbsp;
                  ...
                  <View style={[styles.formRow]}>
                    <View style={styles.formLabel}>
                      <Text style={styles.labelText}>
                        <Icon name="md-arrow-round-up" size={20} />
                      </Text>
                    </View>
